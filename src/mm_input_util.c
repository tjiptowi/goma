...
int
look_for_optional_int(FILE *ifp, const char *stringMatch, int *intValue,
                      const int intDefault)
    ...
    *************************************************************************/
{
  ...
  if (intValue == NULL) {
    EH(-1,"look_for_optional_int ERROR: Incoming value of intValue is NULL");
  }
  if (stringMatch == NULL) {
    EH(-1,"look_for_optional_int ERROR: Incoming value of stringMatch is NULL");
  }
...
int
read_int(FILE *ifp, const char *intName)
...
double
read_dbl(FILE *ifp, const char *dblName)
...
int
read_1_boolean(FILE *ifp, const char *boolName)
...
int
variable_string_to_int(const char *input, const char *err_string)
...
{
  int var = -10;
  if      (!strcmp(input, "VELOCITY1"))                   var = VELOCITY1;
  ...
  else if (!strcmp(input, "MESH_DISPLACEMENT3"))          var = MESH_DISPLACEMENT3;
  else if (!strcmp(input, "SURFACE"))                     var = SURFACE;
  else if (!strcmp(input, "PRESSURE"))                    var = PRESSURE;

  else if (!strcmp(input, "POLYMER_STRESS11"))            var = POLYMER_STRESS11;
  else if (!strcmp(input, "POLYMER_STRESS12"))            var = POLYMER_STRESS12;
  else if (!strcmp(input, "POLYMER_STRESS13"))            var = POLYMER_STRESS13;
  ...
  else if (!strcmp(input, "SOLID_DISPLACEMENT3"))         var = SOLID_DISPLACEMENT3;

  else if (!strcmp(input,"VELOCITY_GRADIENT11"))          var = VELOCITY_GRADIENT11;
  else if (!strcmp(input,"VELOCITY_GRADIENT12"))   	  var = VELOCITY_GRADIENT12;
  else if (!strcmp(input,"VELOCITY_GRADIENT13"))          var = VELOCITY_GRADIENT13;
  else if (!strcmp(input,"VELOCITY_GRADIENT21"))          var = VELOCITY_GRADIENT21;
  else if (!strcmp(input,"VELOCITY_GRADIENT22"))          var = VELOCITY_GRADIENT22;
  else if (!strcmp(input,"VELOCITY_GRADIENT23"))          var = VELOCITY_GRADIENT23;
  ...
  else if (!strcmp(input, "LS"))                          var = FILL;
  else if (!strcmp(input, "SHEAR_RATE"))                  var = SHEAR_RATE;

  else if (!strcmp(input, "PVELOCITY1"))                  var = PVELOCITY1;
  else if (!strcmp(input, "PVELOCITY2"))                  var = PVELOCITY2;
  else if (!strcmp(input, "PVELOCITY3"))                  var = PVELOCITY3;

  /*
   * Kluge to break up large if block. Problems with HP compiler
   */
  if (var != -10) return var;
  /*
   * Multimode viscoelasticity
   */
  if      (!strcmp(input, "POLYMER_STRESS11_1"))          var = POLYMER_STRESS11_1;
  else if (!strcmp(input, "POLYMER_STRESS12_1"))          var = POLYMER_STRESS12_1;
  else if (!strcmp(input, "POLYMER_STRESS22_1"))          var = POLYMER_STRESS22_1;
  else if (!strcmp(input, "POLYMER_STRESS13_1"))          var = POLYMER_STRESS13_1;
  else if (!strcmp(input, "POLYMER_STRESS23_1"))          var = POLYMER_STRESS23_1;
  else if (!strcmp(input, "POLYMER_STRESS33_1"))          var = POLYMER_STRESS33_1;
  
  else if (!strcmp(input, "POLYMER_STRESS11_2"))          var = POLYMER_STRESS11_2;
  else if (!strcmp(input, "POLYMER_STRESS12_2"))          var = POLYMER_STRESS12_2;
  else if (!strcmp(input, "POLYMER_STRESS22_2"))          var = POLYMER_STRESS22_2;
  else if (!strcmp(input, "POLYMER_STRESS13_2"))          var = POLYMER_STRESS13_2;
  else if (!strcmp(input, "POLYMER_STRESS23_2"))          var = POLYMER_STRESS23_2;
  else if (!strcmp(input, "POLYMER_STRESS33_2"))          var = POLYMER_STRESS33_2;

  else if (!strcmp(input, "POLYMER_STRESS11_3"))          var = POLYMER_STRESS11_3;
  else if (!strcmp(input, "POLYMER_STRESS12_3"))          var = POLYMER_STRESS12_3;
  else if (!strcmp(input, "POLYMER_STRESS22_3"))          var = POLYMER_STRESS22_3;
  else if (!strcmp(input, "POLYMER_STRESS13_3"))          var = POLYMER_STRESS13_3;
  else if (!strcmp(input, "POLYMER_STRESS23_3"))          var = POLYMER_STRESS23_3;
  else if (!strcmp(input, "POLYMER_STRESS33_3"))          var = POLYMER_STRESS33_3;

  else if (!strcmp(input, "POLYMER_STRESS11_4"))          var = POLYMER_STRESS11_4;
  else if (!strcmp(input, "POLYMER_STRESS12_4"))          var = POLYMER_STRESS12_4;
  else if (!strcmp(input, "POLYMER_STRESS22_4"))          var = POLYMER_STRESS22_4;
  else if (!strcmp(input, "POLYMER_STRESS13_4"))          var = POLYMER_STRESS13_4;
  else if (!strcmp(input, "POLYMER_STRESS23_4"))          var = POLYMER_STRESS23_4;
  else if (!strcmp(input, "POLYMER_STRESS33_4"))          var = POLYMER_STRESS33_4;

  else if (!strcmp(input, "POLYMER_STRESS11_5"))          var = POLYMER_STRESS11_5;
  else if (!strcmp(input, "POLYMER_STRESS12_5"))          var = POLYMER_STRESS12_5;
  else if (!strcmp(input, "POLYMER_STRESS22_5"))          var = POLYMER_STRESS22_5;
  else if (!strcmp(input, "POLYMER_STRESS13_5"))          var = POLYMER_STRESS13_5;
  else if (!strcmp(input, "POLYMER_STRESS23_5"))          var = POLYMER_STRESS23_5;
  else if (!strcmp(input, "POLYMER_STRESS33_5"))          var = POLYMER_STRESS33_5;
  
  else if (!strcmp(input, "POLYMER_STRESS11_6"))          var = POLYMER_STRESS11_6;
  else if (!strcmp(input, "POLYMER_STRESS12_6"))          var = POLYMER_STRESS12_6;
  else if (!strcmp(input, "POLYMER_STRESS22_6"))          var = POLYMER_STRESS22_6;
  else if (!strcmp(input, "POLYMER_STRESS13_6"))          var = POLYMER_STRESS13_6;
  else if (!strcmp(input, "POLYMER_STRESS23_6"))          var = POLYMER_STRESS23_6;
  else if (!strcmp(input, "POLYMER_STRESS33_6"))          var = POLYMER_STRESS33_6;

  else if (!strcmp(input, "POLYMER_STRESS11_7"))          var = POLYMER_STRESS11_7;
  else if (!strcmp(input, "POLYMER_STRESS12_7"))          var = POLYMER_STRESS12_7;
  else if (!strcmp(input, "POLYMER_STRESS22_7"))          var = POLYMER_STRESS22_7;
  else if (!strcmp(input, "POLYMER_STRESS13_7"))          var = POLYMER_STRESS13_7;
  else if (!strcmp(input, "POLYMER_STRESS23_7"))          var = POLYMER_STRESS23_7;
  else if (!strcmp(input, "POLYMER_STRESS33_7"))          var = POLYMER_STRESS33_7;
   ...
   */
  else if (!strcmp(input,"SPECIES_MASS_FRACTION"))        var = SPECIES_MASS_FRACTION;
  else if (!strcmp(input,"SPECIES_MOLE_FRACTION"))        var = SPECIES_MOLE_FRACTION;
  else if (!strcmp(input,"SPECIES_VOL_FRACTION"))         var = SPECIES_VOL_FRACTION;
  else if (!strcmp(input,"SPECIES_DENSITY"))              var = SPECIES_DENSITY;
  else if (!strcmp(input,"SPECIES_CONCENTRATION"))        var = SPECIES_CONCENTRATION;
  else if (!strcmp(input,"SPECIES_CAP_PRESSURE"))         var = SPECIES_CAP_PRESSURE;
   ...
   */
  if      (!strcmp(input,"EXTERNAL"))                     var = EXTERNAL;

  else if (!strcmp(input,"MESH_POSITION1"))               var = MESH_POSITION1;
  else if (!strcmp(input,"MESH_POSITION2"))               var = MESH_POSITION2;
  else if (!strcmp(input,"MESH_POSITION3"))               var = MESH_POSITION3;
  else if (!strcmp(input,"R_MOM_NORMAL"))                 var = R_MOM_NORMAL;
  else if (!strcmp(input,"R_MOM_TANG1"))                  var = R_MOM_TANG1;
  else if (!strcmp(input,"R_MOM_TANG2"))                  var = R_MOM_TANG2;
  else if (!strcmp(input,"R_MESH_NORMAL"))                var = R_MESH_NORMAL;
  else if (!strcmp(input,"R_MESH_TANG1"))                 var = R_MESH_TANG1;
  else if (!strcmp(input,"R_MESH_TANG2"))                 var = R_MESH_TANG2;
  else if (!strcmp(input,"VEL_NORM"))                     var = VEL_NORM;
  else if (!strcmp(input,"VEL_NORMAL"))                   var = VEL_NORM;
  else if (!strcmp(input,"VEL_TANG1"))                    var = VEL_TANG1;
  else if (!strcmp(input,"VEL_TANG2"))                    var = VEL_TANG2;
  else if (!strcmp(input,"MESH_NORM"))                    var = MESH_NORM;
  else if (!strcmp(input,"MESH_NORMAL"))                  var = MESH_NORM;
  else if (!strcmp(input,"MESH_TANG1"))                   var = MESH_TANG1;
  else if (!strcmp(input,"MESH_TANG2"))                   var = MESH_TANG2;
  else if (!strcmp(input,"SOLID_POSITION1"))              var = SOLID_POSITION1;
  else if (!strcmp(input,"SOLID_POSITION2"))              var = SOLID_POSITION2;
  else if (!strcmp(input,"SOLID_POSITION3"))              var = SOLID_POSITION3;
  else if (!strcmp(input,"R_SOLID_NORMAL"))                var = R_SOLID_NORMAL;
  else if (!strcmp(input,"R_SOLID_TANG1"))                 var = R_SOLID_TANG1;
  else if (!strcmp(input,"R_SOLID_TANG2"))                 var = R_SOLID_TANG2;

  else if (!strcmp(input,"R_ANYTHING"))                   var = R_ANYTHING;

  else if (!strcmp(input,"D_VEL1_DT"))                    var = D_VEL1_DT;
  else if (!strcmp(input,"D_VEL2_DT"))                    var = D_VEL2_DT;
  else if (!strcmp(input,"D_VEL3_DT"))                    var = D_VEL3_DT;
  else if (!strcmp(input,"D_T_DT"))                       var = D_T_DT;
  else if (!strcmp(input,"D_Y_DT"))                       var = D_Y_DT;
  else if (!strcmp(input,"D_X1_DT"))                      var = D_X1_DT;
  else if (!strcmp(input,"D_X2_DT"))                      var = D_X2_DT;
    ...
    EH(-1, "Invalid variable type on card expecting string names of variables");
    var = -2;
  }
  return var;
}
...
int
species_type_str_to_int(char *input)
...
{
  int var = 0;
  if      (!strcmp(input,"SPECIES_MASS_FRACTION")) var = SPECIES_MASS_FRACTION;
  else if (!strcmp(input,"SPECIES_MOLE_FRACTION")) var = SPECIES_MOLE_FRACTION;
  else if (!strcmp(input,"SPECIES_VOL_FRACTION"))  var = SPECIES_VOL_FRACTION;
  else if (!strcmp(input,"SPECIES_DENSITY"))       var = SPECIES_DENSITY;
  else if (!strcmp(input,"SPECIES_CONCENTRATION")) var = SPECIES_CONCENTRATION;
  ...
  if (var == 0) {
    ...
    EH(-1, "Invalid species type input");
  }
  return var;
}
/*****************************************************************************/
...
void
species_type_int_to_str(char *str, const int var)
...
int
interpret_string(const char *string, char *retn_string)
...
int
interpret_int(const char *string, int *retn_value)
...
/*****************************************************************************/
int
interpret_double(const char *string, double *retn_value)
...
int
indentify_species_ID_string(const char *input, const char *list,
		       	    const int numList)
...
int 
look_for_species_prop(FILE *imp,  const char *search_string,   
		      MATRL_PROP_STRUCT *mat_ptr,  int  *materialModel,	
		      dbl  material_property[], dbl  **User_constants,
		      int  *User_count,  char *model_name,
		      const int  num_values_expected,  int *species_index,
		      char *echo_string )  
     ...
     ***********************************************************************/
{
  ...
  species_ID = indentify_species_ID_string(species_str, mat_ptr->Species_Names[0],
		      		           mat_ptr->Num_Species);
  if (species_ID == -1) {
    fprintf(stderr,
	    "%s error: reading model name string, mat file \"%s\", property %s\n",
  ...
  if (num_values_expected > 0 && strcmp(model_name, "USER")) 
    ...
    if (num_args != num_values_expected) 
      {
	fprintf(stderr,
		"%s Warning: reading model name string, mat file \"%s\", property %s\n",
		yo, mat_ptr->Material_Name, search_string);
	
	fprintf(stderr,
		"\tNumber of expected args, %d, differs from actual, %d\n",
...
int 
look_for_porous_prop(FILE *imp,  const char *search_string,   
		      MATRL_PROP_STRUCT *mat_ptr,  int  *materialModel,	
		      dbl  material_property[], dbl  **User_constants,
		      int  *User_count,  char *model_name,
		     const int  num_values_expected,  int *porous_index,
		     char * echo_string )  
     ...
     ***********************************************************************/
{
  ...
  porous_ID = indentify_species_ID_string(porous_str, mat_ptr->Porous_Names[0],
		      		           mat_ptr->Num_Porous_Eqn);
  if (porous_ID == -1) {
    fprintf(stderr,
	    "%s error: reading model name string, mat file \"%s\", property %s\n",
	    yo, mat_ptr->Material_Name, search_string);
...
int 
look_for_species_proptable(FILE *imp,  
			   char *search_string,   
...
/* If model_name is TABLE */
  ...
  if (!strcmp(model_name, "CONSTANT")) 
	...
	{
	  fprintf(stderr, 
		  "ERROR ReReading model_name for TABLE model for property %s in mat \"%s\" requires space!",
...
int
stokenize(char *string, const char *delimiters, char **token_ptrs,
...
int
tokenize_by_whsp(char *string, char **token_ptrs, const int max_tokens)
...
int
fillTokStruct(TOKEN_STRUCT *tp, const char *string)
...
int
in_char_list(const char *target, const char *list, const int num_list)
     ...
     ************************************************************************/
{
  ...
  for (i = 0; i < num_list; i++) {
    if (list_ptr != NULL) {
      if (! strcmp(target, list_ptr)) return i;
    }
    list_ptr++;
  }
  return -1;
...
int
read_line(FILE *ifp, char input[], const int print_flag)
...
int 
read_string (FILE *ifp, char string[], const char ch)
...
{	 
  int   i = 0;
  int   new_ch;
  while ( (i < MAX_CHAR_IN_INPUT) && ((new_ch = getc(ifp)) != ch)
          && (new_ch != '\n')
          && (new_ch != EOF) ) {
    string[i++] = new_ch;
  }
